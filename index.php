...
<body>
    <section id="hero">
        <div class="container">
            <div class="d-flex h-100 flex-column text-light justify-content-center">
                <h1 class="display-1">RENT A CAR</h1>
    ...
    <section class="generic" id="about">
        <div class="container">
            <h2 class="display-5 text-info mb-5">KENDİN İÇİN DOĞRU ARABAYI BUL</h2>
            <div class="row mb-4">
                <div class="col-sm-12 col-md-8 bg-light">
                    <div class="d-flex h-100 flex-column justify-content-center">
                        <p>Sizin için en doğru arabayı uygun fiyatla hizmetinize sunuyoruz.
                        </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4 p-0">
                    <img class="img-fluid" src="img/key.jpg">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 order-first p-0">
                    <img class="img-fluid" src="img/cars.jpg">
                </div>
            </div>
        </div>
    </section>
...
<!-- body tag icine eklemeliyim script tagini-->
</body>
